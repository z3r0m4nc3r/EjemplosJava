...
System.out.println("*******************************************************");
	...
	static void picoContagios() {
		...
		System.out.println("Fecha en la que se notificaron m�s contagios: "
		+dia.format(dtf)+
		" Total de positivos : "
	...
	static void totalPositivosComunidad() {
		...
		try {
			...
			+service.totalPositivosComunidad(ciudad)+" Total en Espa�a: "+service.totalPositivosPais());
			System.out.println("Porcentaje de contagiados de "+ciudad
					+" respecto del total en Espa�a "+(service.totalPositivosComunidad(ciudad)*100)
